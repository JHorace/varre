...
using ::varre::engine::AcquiredFrame;
using ::varre::engine::FrameAcquireStatus;
using ::varre::engine::FrameLoop;
using ::varre::engine::FrameLoopCreateInfo;
using ::varre::engine::FramePresentRequest;
using ::varre::engine::FramePresentStatus;
using ::varre::engine::FrameSyncPrimitives;
using ::varre::engine::GraphicsSubmitBatch;
using ::varre::engine::PresentedFrame;
using ::varre::engine::SubmitSemaphoreWait;
} // namespace varre::engine::sync
